...
# Function to process the raw data and calculate EU GDP pc based on US index (US=100)
def process_data():
    # URL to the raw data
...
if __name__ == "__main__":
    ...
    processed_data_path = os.path.join(processed_data_folder, "INDEX_WID_GDP.csv")
